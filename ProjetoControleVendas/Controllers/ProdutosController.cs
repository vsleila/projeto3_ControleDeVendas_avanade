...
namespace ProjetoControleVendas.Controllers
{
    public class ProdutosController : Controller
    {
        ...
        public ProdutosController(ProjetoControleVendasContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("ProdutosID")] Produtos produtos)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProdutosID")] Produtos produtos)
        {
